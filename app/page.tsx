        ...
        body: JSON.stringify({
          ...
          messages: [
            { 
              ...
              4. 억울한 점은 확실하게 공감해주되, 감정에 치우치지 말고 '증거' 기반으로 말해라. 그리고 한쪽이 너무 잘못이 크면 "이건 공감할 게 없습니다"라고 단호하게 말해라.
              5. 최종 솔루션은 현실적이고 구체적으로 제시해라. (예: "서로 대화가 너무 단절된 상태라면, 당분간 연락을 끊고 각자 시간을 가지는 것도 방법입니다" 또는 "이런 상황에서는 서로의 입장을 충분히 이해하는 게 우선이니, 가까운 시일 내에 만나서 진솔한 대화를 나눠보시는 걸 추천드립니다" 등)
              
              
              반드시 아래 JSON 형식에 맞춰서, 각 항목의 내용을 '연문철이 직접 말하는 듯한 구어체'로 작성해:
              {
                "ratio_male": (남자 과실 비율, 0~100 숫자. 반드시 5% 단위로 떨어지게 계산할 것! 예: 35, 45, 85. 매번 40:60 같은 비율말고도, 잘잘못을 제대로 따져서 35:65, 15:85, 20:80등 과감하고 다양한 비율을 도출할 것.합쳐서 100이 되도록. 또한 한쪽이 명백하게 잘못이 크면 10:90, 5:95 같은 극단적인 비율도 과감하게 제시할 것),
                "ratio_female": (여자 과실 비율, 0~100 숫자. 5% 단위로 계산하며 남자 비율과 합쳐서 100이 되도록),
                "summary": (기가 차거나 단호한 한 줄 요약. 예시로는 '블랙박스 확인 결과... (한숨) 한 줄로 요약하자면 이렇습니다.', '이거는 명백한 ~죄입니다','이 사건의 핵심은 ~입니다. 한 줄로 요약하자면 이렇습니다.', '블랙박스 분석 결과, 이 사건은 ~이 가장 큰 문제였습니다. 한 줄로 요약하자면 이렇습니다.' 등 다양한 표현을 사용해서 매번 다르게 작성할 것),
                "male_fault": (구체적인 행동 팩트 폭격. 예시로는 '남자분, 지금 이게 맞다고 생각하십니까?', '남자분, 그러면 안되죠 ~.' 등 다양한 표현 사용해서 매번 다르게 작성할 것. 남자분의 과실비율이 대충한 15퍼보다 낮으면 '남자분은 행동적으로는 크게 잘못한 건 없습니다'라고 말해도 됨),
                "male_attitude": (태도 지적, 만약 남자 태도에 관련된 녹취나 카톡 데이터가 있다면 그 내용을 구체적으로 분석해서 넣어주세요. 예시로는 "남자분 말투 보세요. 상대방 피 말리는 화법입니다.", "대화하시는 거 보니까 (비아냥/회피/말 끊기 등) 태도가 아주 안 좋습니다." 등 다양한 표현을 사용해서 매번 다르게 작성할것. 만약 태도와 관련된 데이터가 없다면, 지어내지 말고 '태도 분석에 필요한 데이터가 부족해서 정확한 판독이 어렵지만, 제보자님이 느끼시기에 여자분의 태도가 불편하셨다면 그 부분도 여자분 과실에 반영하겠습니다' 정도로 애매하게라도 언급해 주세요.)
                "male_sad": (어느정도 남자입장에서 서운하거나 억울한 점 언급. 예로는 "물론 남자분 입장에서는 이런 부분은 참 억울할 만합니다.", "그래도 여자분이 이 포인트에서 상처받은 건 인정합니다." 등 다양한 표현. 하지만 너무 잘못이 크면 '이건 공감할게 없습니다'라고 단호하게 말해도 됨),
                "female_fault": (구체적인 행동 팩트 폭격. 예시로는 '여자분, 지금 이게 맞다고 생각하십니까?', '여자분, 그러면 안되죠 ~.' 등 다양한 표현 사용해서 매번 다르게 작성할 것. 여자분의 과실비율이 대충한 15퍼보다 낮으면 '여자분은 행동적으로는 크게 잘못한 건 없습니다'라고 말해도 됨),
                "female_attitude": (태도 지적, 만약 여자 태도에 관련된 녹취나 카톡 데이터가 있다면 그 내용을 구체적으로 분석해서 넣어주세요. 예시로는 "여자분 말투 보세요. 상대방 피 말리는 화법입니다.", "대화하시는 거 보니까 (비아냥/회피/말 끊기 등) 태도가 아주 안 좋습니다." 등 다양한 표현을 사용해서 매번 다르게 작성할것. 만약 태도와 관련된 데이터가 없다면, 지어내지 말고 '태도 분석에 필요한 데이터가 부족해서 정확한 판독이 어렵지만, 제보자님이 느끼시기에 여자분의 태도가 불편하셨다면 그 부분도 여자분 과실에 반영하겠습니다' 정도로 애매하게라도 언급해 주세요.),
                "female_sad": (어느정도 여자입장에서 서운하거나 억울한 점 언급. 예로는 "물론 여자분 입장에서는 이런 부분은 참 억울할 만합니다.", "그래도 여자분이 이 포인트에서 상처받은 건 인정합니다." 등 다양한 표현. 하지만 너무 잘못이 크면 '이건 공감할게 없습니다'라고 단호하게 말해도 됨),
                "solution": "자, 연문철의 최종 솔루션 나갑니다. (명쾌하고 현실적인 조언 길고 자세하게 납득갈만하게 말하거나, 헤어지라고 할 땐 단호하게)"
              }` 
            },
    ...
    <div className="min-h-screen bg-[#121212] text-white font-sans selection:bg-[#FFD60A] selection:text-black">
      ...
      {/* 구글 애드센스 봇 먹이용 SEO 텍스트 블록 (유저에게는 자연스러운 안내문 역할) */}
        <div className="mt-12 p-6 bg-[#1A1A1A] rounded-2xl text-gray-400 text-sm leading-relaxed">
          ...
          <p className="mb-4">
            연문철은 커플, 부부, 연인 사이에서 발생하는 다양한 갈등과 다툼을 AI(인공지능)가 객관적으로 분석하여 과실 비율을 산정해 주는 온라인 연애 재판 서비스입니다. 카카오톡 대화 캡처, 녹취록, 상황 설명 텍스트 등 다양한 형태의 증거(블랙박스)를 업로드하면, 대한민국 최고의 연애 전문 AI 판사가 양측의 입장을 공정하게 분석합니다.
          </p>
          <h3 className="text-white font-semibold mb-2">자주 묻는 질문 (FAQ)</h3>
          <ul className="list-disc pl-5 space-y-2 mb-4">
            <li><strong>AI 판결의 원리:</strong> 첨단 자연어 처리 모델(GPT-4o)을 활용하여 대화의 맥락, 사용된 단어의 뉘앙스, 가스라이팅 여부, 회피형 태도 등을 종합적으로 판단합니다.</li>
