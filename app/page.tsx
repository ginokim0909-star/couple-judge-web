          ...
          messages: [
            { 
              ...
              반드시 아래 JSON 형식에 맞춰서, 각 항목의 내용을 '연문철이 직접 말하는 듯한 구어체'로 작성해:
              {
                ...
                "male_fault": "남자분, 지금 이게 맞다고 생각하십니까? (구체적인 행동 팩트 폭격. 남자분이 잘못한 게 없다면 '남자분은 행동적으로는 크게 잘못한 건 없습니다'라고 말해도 됨)",
                "male_attitude": "대화하시는 거 보니까 (비아냥/회피/말 끊기 등) 태도가 아주 안 좋습니다. (태도 지적, 만약 남자 태도에 관련된 녹취나 카톡 데이터가 있다면 그 내용을 구체적으로 분석해서 넣어주세요. 만약 태도와 관련된 데이터가 없다면, 지어내지 말고 '태도 분석에 필요한 데이터가 부족해서 정확한 판독이 어렵지만, 제보자님이 느끼시기에 남자분의 태도가 불편하셨다면 그 부분도 남자분 과실에 반영하겠습니다' 정도로 애매하게라도 언급해 주세요.",
                "male_sad": "물론 남자분 입장에서는 이런 부분은 참 억울할 만합니다. (하지만 너무 잘못이 크면 '이건 공감할게 없습니다'라고 단호하게 말해도 됨)",
                "female_fault": "여자분도 잘한 거 없습니다. (구체적인 행동 팩트 폭격. 여자분이 잘못한 게 없다면 '여자분은 행동적으로는 크게 잘못한 건 없습니다'라고 말해도 됨)",
                "female_attitude": "여자분 말투 보세요. 상대방 피 말리는 화법입니다. (태도 지적, 만약 여자 태도에 관련된 녹취나 카톡 데이터가 있다면 그 내용을 구체적으로 분석해서 넣어주세요. 만약 태도와 관련된 데이터가 없다면, 지어내지 말고 '태도 분석에 필요한 데이터가 부족해서 정확한 판독이 어렵지만, 제보자님이 느끼시기에 여자분의 태도가 불편하셨다면 그 부분도 여자분 과실에 반영하겠습니다' 정도로 애매하게라도 언급해 주세요.",
                "female_sad": "그래도 여자분이 이 포인트에서 상처받은 건 인정합니다. (하지만 너무 잘못이 크면 '이건 공감할게 없습니다'라고 단호하게 말해도 됨)",
